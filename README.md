...
```shell
$ bin/omnibus clean brokencache
```

Adding the `--purge` purge option removes __ALL__ files generated during the
build including the project install directory (`/opt/brokencache`) and
the package cache directory (`/var/cache/omnibus/pkg`):

```shell
$ bin/omnibus clean brokencache --purge
```
...
[vagrant@ubuntu...] $ cd brokencache
[vagrant@ubuntu...] $ bundle install
[vagrant@ubuntu...] $ ...
[vagrant@ubuntu...] $ bin/omnibus build brokencache
```
